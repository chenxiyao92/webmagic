...
public class PssGovList {
    public static void main(String[] args) {
        ...
        //其中cookie用户验证用户信息;
        maps.put("Cookie", "IS_LOGIN=true;" +
                " WEE_SID=g9nOBC1fi0hIVSQKVMjQyZScArb4MC7OoP3coJ4RydPl5K3Cy-GW!-155051809!-1122471164!1528169770335;" +
                " wee_username=Y3h5NDM3NjAxNTQ1; wee_password=am9uYXM2NTYxMDExMg%3D%3D;" +
                " locale=en_US; avoid_declare=declare_pass;" +
                " JSESSIONID=g9nOBC1fi0hIVSQKVMjQyZScArb4MC7OoP3coJ4RydPl5K3Cy-GW!-155051809!-1122471164");
        maps.put("Host", "www.pss-system.gov.cn");
        maps.put("Origin", "http://www.pss-system.gov.cn");
        maps.put("Proxy-Connection", "keep-alive");
        maps.put("Referer", "http://www.pss-system.gov.cn/sipopublicsearch/patentsearch/tableSearch-showTableSearchIndex.shtml");
        ...
        HttpPost httpPost = new HttpPost("http://www.pss-system.gov.cn/sipopublicsearch/patentsearch/executeTableSearch0529-executeCommandSearch.shtml");
         ...
         * resultPagination.limit=12
         */
        parameters.add(new BasicNameValuePair("searchCondition.searchExp","((%E5%8F%91%E6%98%8E%E5%90%8D%E7%A7%B0%3D(%E7%BE%8E%E7%9A%84)))"));
        ...
        parameters.add(new BasicNameValuePair("extendInfo%5B'MODE'%5D", "MODE_TABLE"));
        parameters.add(new BasicNameValuePair("extendInfo%5B'STRATEGY'%5D", "STRATEGY_CALCULATE"));
